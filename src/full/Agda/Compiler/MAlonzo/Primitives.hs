...
importsForPrim builtinThings defs = xForPrim table builtinThings defs ++ [HS.ModuleName "Data.Text"]
  ...
  table = Map.fromList $ map (second HS.ModuleName)
    ...
    , someBuiltin PrimNatToFloat             |-> "MAlonzo.RTE.Float"
    , someBuiltin PrimIntToFloat             |-> "MAlonzo.RTE.Float"
    ...
    , someBuiltin PrimFloatPlus              |-> "MAlonzo.RTE.Float"
    , someBuiltin PrimFloatMinus             |-> "MAlonzo.RTE.Float"
    , someBuiltin PrimFloatTimes             |-> "MAlonzo.RTE.Float"
    , someBuiltin PrimFloatNegate            |-> "MAlonzo.RTE.Float"
    , someBuiltin PrimFloatDiv               |-> "MAlonzo.RTE.Float"
    , someBuiltin PrimFloatPow               |-> "MAlonzo.RTE.Float"
    , someBuiltin PrimFloatSqrt              |-> "MAlonzo.RTE.Float"
    , someBuiltin PrimFloatExp               |-> "MAlonzo.RTE.Float"
    , someBuiltin PrimFloatLog               |-> "MAlonzo.RTE.Float"
    , someBuiltin PrimFloatSin               |-> "MAlonzo.RTE.Float"
    , someBuiltin PrimFloatCos               |-> "MAlonzo.RTE.Float"
    , someBuiltin PrimFloatTan               |-> "MAlonzo.RTE.Float"
    , someBuiltin PrimFloatASin              |-> "MAlonzo.RTE.Float"
    , someBuiltin PrimFloatACos              |-> "MAlonzo.RTE.Float"
    , someBuiltin PrimFloatATan              |-> "MAlonzo.RTE.Float"
    , someBuiltin PrimFloatATan2             |-> "MAlonzo.RTE.Float"
    , someBuiltin PrimFloatSinh              |-> "MAlonzo.RTE.Float"
    , someBuiltin PrimFloatCosh              |-> "MAlonzo.RTE.Float"
    , someBuiltin PrimFloatTanh              |-> "MAlonzo.RTE.Float"
    , someBuiltin PrimFloatASinh             |-> "MAlonzo.RTE.Float"
    , someBuiltin PrimFloatACosh             |-> "MAlonzo.RTE.Float"
    , someBuiltin PrimFloatATanh             |-> "MAlonzo.RTE.Float"
